    ...
    for(int i=1;i<4;){
    	...
    	if(user.equals("1") && password.equals("1")){
    		...
    		for(int x=1; x==1;){
                ...
                System.out.println("\t\t\t********************************************");
                System.out.println("\t\t\t** WELCOME TO LOVE BUS RESERVATION CORNER   **");
                System.out.println("\t\t\t********************************************");
    			System.out.println("\t\t\t********************************************");
    			...
    			for(x=1; x==1;){
					...
					if (choice.equals("1")){
    					...
    					System.out.println("\t\t\t***************************************");
						System.out.println("\t\t\t** 1.)Ahmedabad     | 500 |   "+available[1]+"   **");
    					System.out.println("\t\t\t** 2.)Surat        | 600  |   "+available[2]+"   **");
    					System.out.println("\t\t\t** 3.)Boroda       |500   |   "+available[3]+"   **");
    					System.out.println("\t\t\t** 4.)Rajkot       | 400  |   "+available[4]+"   **");
    					System.out.println("\t\t\t** 5.)Mumbai       | 1050 |   "+available[5]+"   **");
    					System.out.println("\t\t\t***************************************");
						System.out.println("\t\t\t***************************************\n");
					...
					//if CHOICE is "2" proceed to Ticket Booking//
    					...
    					String dest[] = { " ", "Ahmedabad", "Surat", "Boroda", "Rajkot", "Mumbai"};
    					double fare[] = { 0,500,600,500,400,1050};
						...
						x=0;
						System.out.println("Thank You!!!for using software of love");
					}
    			...
    			for(y=1; y==1;){
    				...
    				if (yn.equalsIgnoreCase("y")){
    					...
    					System.out.println("\nThank You!!! for using software of love");
    					break;
    				}
    				else{
    					System.out.println("Invalid Input!!!");
